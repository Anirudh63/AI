...
def diagnose_allergies():
    ...
    ) or ask_question("Do you have red, watery eyes?")


def diagnose_fever():
    return ask_question(
        "Do you have a temperature above 37.5°C?"
    ) or ask_question("Do you experience chills?")


def diagnose_cold():
    return ask_question(
        "Do you have a runny or stuffy nose?"
    ) or ask_question("Are you sneezing frequently?")
...
def diagnose_appendicitis():
    ...
    ) and ask_question("Have you lost your appetite?")
